      ...
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <div className="flex-1 md:flex md:items-center md:gap-12">
            <h4 className="text-2xl font-bold text-white">Industry Portal</h4>
          </div>
          ...
          <div className="md:flex md:items-center md:gap-12">
            <nav aria-label="Global" className="hidden md:block">
              <ul className="flex items-center gap-6 text-sm">
                <li>
                  <Link className="text-white" to="/industry-dashboard"> Profile </Link>
                </li>

                <li>
                  <Link className="text-white" to="waste-search"> Waste Search</Link>
                </li>
                ...
                {/* <li>
                  <Link className="text-white" to="/farmer-dashboard/waste-listing"> Waste Listing </Link>
                </li>
